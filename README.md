...
Short description: Trust-first J-Beauty discovery with verified sourcing and a persistent shelf.
...
Current prototype coverage is included in a single file:
- `alana_screens_redesigned.html` - Combined showcase of the core Phase 1 flows (recommended entry point)
